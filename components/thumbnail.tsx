...
export const Thumbnail = ({
    ...
    return (
        <div className="group aspect-video relative rounded-md cursor-pointer">
            <div className="rounded-md absolute inset-0 bg-gray-600 opacity-0 group-hover:opacity-100 transition-opacity 
...
export const ThumbnailSkeleton = () => {
    return (
        <div className="group aspect-video rlative rounded-xl cursor-pointer">
